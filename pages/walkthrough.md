...
Be sure to keep the terminal window open while you are editing the Tangram map.
...
3. Copy the text of the key to your clipboard. It should take the form of `mapzen-xxxxxx`.
